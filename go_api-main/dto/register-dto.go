...
type RegisterDTO struct {
	...
	CompanyName string    `json:"companyName" form:"name" bindding:"required"`
	CountryCode string    `json:"countryCode" form:"code" bindding:"iso3166_1_alpha2"`
	CountryName string    `json:"countryName" form:"name" bindding:"required"`
